...
import 'package:MedCare/Screens/agenda_medicamento_list.dart';
...
class NotificationPlugin {
  ...
  onNotificationClick(payload) async {
    ...
    Agenda objAgenda = await databaseHelper.getAgendaById(int.parse(payload));
    await MyApp.navigatorKey.currentState.push(MaterialPageRoute(
        builder: (context) => AgendaMedicamentoList(objAgenda)));
  }
  ...
  Future<void> showDailyAtTime(int id, String title, String body, int hour,
      int minute, String payload) async {
    ...
    var androidChannelSpecifics = AndroidNotificationDetails(
      ...
      priority: Priority.High,
      playSound: true,
      sound: RawResourceAndroidNotificationSound('alarm_medicacao'),
    );
    var iosChannelSpecifics = IOSNotificationDetails();
    var platformChannelSpecifics =
        NotificationDetails(androidChannelSpecifics, iosChannelSpecifics);
